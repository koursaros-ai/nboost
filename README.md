...
Takes an Elasticsearch query for <b>k</b> results, magnifies the return set by some arbitrary factor <b>n</b>, reranks the results with a regresion transformer model, and returns the top k.
</p>
