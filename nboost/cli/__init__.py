...
def add_default_args(parser: ArgumentParser) -> ArgumentParser:
    ...
    parser.add_argument('--uhost', type=str, default='127.0.0.1', help='host of the server')
    parser.add_argument('--uport', type=int, default=9200, help='port of the server')
    parser.add_argument('--lr', type=float, default=10e-3, help='learning rate of the model')
    parser.add_argument('--model_dir', type=str, default='bert-base-uncased-msmarco', help='name or directory of the finetuned model')
