...
def set_parser() -> ArgumentParser:
    ...
    parser.add_argument('--qa_model', type=lambda x: import_class('models', x), default="QAModel", help=QA_MODEL)
    parser.add_argument('--qa_model_dir', type=str, default='', help=QA_MODEL_DIR)
    return parser
